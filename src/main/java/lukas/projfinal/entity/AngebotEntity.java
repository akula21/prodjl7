...
public class AngebotEntity {
    ...
    private String produktgruppe3Id;

    @Column(name = "tiergewicht")
    private double tierGewicht;

    @Column(name = "anzahl der staelle")
    private int anzDerStaelle;                  //? spornoe rewenue
    ...
    public String getProduktgruppe3Id() {
        return produktgruppe3Id;
    }

    public void setProduktgruppe3Id(String produktgruppe3Id) {
    ...
    public int getAnzDerStaelle() {
        return anzDerStaelle;
    }

    public void setAnzDerStaelle(int anzDerStaelle) {
